...
public class ErrorMappingMapper {
    ...
    public ErrorMappingDto toDto(ErrorMapping entity) {
        return ErrorMappingDto.builder().id(entity.getId()).routeId(entity.getRouteId())
                ...
                .rawErrorSubstring(entity.getRawErrorSubstring()).matchType(entity.getMatchType())
                .mappedErrorCode(entity.getMappedErrorCode()).mappedMessage(entity.getMappedMessage())
                ...
                .httpStatusCode(entity.getHttpStatusCode()).language(entity.getLanguage()).active(entity.getActive())
                .createdBy(entity.getCreatedBy()).updatedBy(entity.getUpdatedBy()).createdAt(entity.getCreatedAt())
                .updatedAt(entity.getUpdatedAt()).build();
    }

    public ErrorMapping toEntity(ErrorMappingDto dto) {
        return ErrorMapping.builder().id(dto.getId()).routeId(trimOrNull(dto.getRouteId()))
                .routePath(trimOrNull(dto.getRoutePath()))
                .rawErrorSubstring(trimOrNull(dto.getRawErrorSubstring().replaceAll("\\s+", " ")))
                .matchType(dto.getMatchType()).mappedErrorCode(trimOrNull(dto.getMappedErrorCode()))
                .mappedMessage(trimOrNull(dto.getMappedMessage())).httpStatusCode(dto.getHttpStatusCode())
                .language(trimOrNull(dto.getLanguage())).active(dto.getActive()).createdBy(dto.getCreatedBy())
                .updatedBy(dto.getUpdatedBy()).createdAt(dto.getCreatedAt()).updatedAt(dto.getUpdatedAt()).build();
    }
